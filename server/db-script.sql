...
('xX_MovieLover_Xx', 'jessica.k@example.com', 'b97873a40f73abedd8d685a7cd5e5f85e4a9cfb83eac26886640a0813850122b', 'https://preview.redd.it/monke-image-dump-19-v0-lgarrkehrnsa1.jpg?width=1280&format=pjpg&auto=webp&s=9369c4fee3f03b9ad7a36ed6b73e1b70c1649b9f', '2003-07-15', '2025-09-23' ,'Here for a good time! I love Star Wars, no-brainers and popcorn. Don\'t ask me about plot holes lol.'); -- password = password4

INSERT INTO movies (title, description, genre, director, release_date, runtime, poster_url) VALUES
('Inception', 'A thief who steals corporate secrets through the use of dream-sharing technology is given the inverse task of planting an idea into the mind of a C.E.O.', 'Sci-Fi', 'Christopher Nolan', '2010-07-16', 148, 'https://image.tmdb.org/t/p/original/9gk7admal4zl248sEdFAOLiD0nr.jpg'),
('The Shawshank Redemption', 'Two imprisoned men bond over a number of years, finding solace and eventual redemption through acts of common decency.', 'Drama', 'Frank Darabont', '1994-09-22', 142, 'https://image.tmdb.org/t/p/original/q6y0Go1tsGEsmtFryDOJo3dEmqu.jpg'),
...
('Interstellar', 'A team of explorers travel through a wormhole in space in an attempt to ensure humanity\'s survival.', 'Sci-Fi', 'Christopher Nolan', '2014-11-07', 169, 'https://image.tmdb.org/t/p/original/gEU2QniL6E8ahDaNBADBzDCTvu8.jpg'),
...
INSERT INTO ratings (user_id, movie_id, score, comment) VALUES
(4, 1, 8, 'I didn\'t understand half of it lol but it looked cool. Leo is great as always!'), -- Inception
(4, 5, 10, 'BATMAN IS THE GOAT!! Best superhero movie ever made, hands down. RIP Heath Ledger.'), -- Dark Knight
(4, 3, 5, 'way too long and boring. Nothing happens for like an hour. Fell asleep halfway through.'); -- Godfather